...
function App() {
  ...
  useEffect(() => {
    ...
    axios
      .get(`http://127.0.0.1:4000/notes-search/?search=${searchText}`)
      .then((res) => {
        console.log(res.data);
        setNotes(res.data);
      })
  ...
  const addNote = (data) => {
    axios
      .post("http://127.0.0.1:4000/notes/", data)
      .then((res) => {
        console.log(res.data);
        setNotes([...notes, data]);
      })
  ...
  const updateNote = (data, slug) => {
    axios
      .put(`http://127.0.0.1:4000/notes/${slug}/`, data)
      .then((res) => {
        console.log(res.data);
  ...
  const deleteNote = (slug) => {
    axios
      .delete(`http://127.0.0.1:4000/notes/${slug}`)
      .then((res) => {
        console.log(res.data);
